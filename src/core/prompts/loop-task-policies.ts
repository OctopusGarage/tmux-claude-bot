...
function repositoryPullRequestReviewPolicy(workOrder: LoopWorkOrder): string[] {
  ...
  return [
    ...
    '- In the final JSON, include pullRequestDecisions with one entry for every in-scope PR. Each entry must contain number, repository, outcome, evidence, and nextStep. Outcomes are only "merged", "closed", "retry", or "manual-review". A manual-review entry must additionally contain exactly one structured boundary code: "ownership", "protected-branch-policy", "product-decision", "migration-decision", "security-decision", "legal-compliance", or "organization-policy"; never attach boundary to another outcome.',
